/* -----------------------------------------------------------------
    Author: LeventHAN
    Version: v2
    Desc.: DLC Vehicle Unlocker.
    Shared on: ARMAFAN.COM - ARMA3TR.COM
----------------------------------------------------------------- */
...
DLC_Vehicles_Arma_3_Laws_of_War = [
"C_Van_02_service_F",
"C_Van_02_medevac_F",
"C_Van_02_vehicle_F",
...
DLC_ID_Arma_3_Laws_of_War = 571710;
...
if !(DLC_ID_Arma_3_Laws_of_War in _ownedDLCs) then {
    {
        DLC_Vehicle_List pushBack _x;
    } forEach DLC_Vehicles_Arma_3_Laws_of_War;
};
...
DLC_Functions_AddAction = {
    ...
    _displayVehicle = "<t color='#6FFF00'>" + _displayVehicle + "<t/>";
    DLC_AddAction_1 = _vehicle addAction ["<t color='#FF0000'>DLC Araca Bin<t/> " + _displayVehicle + " <t color='#FF0000'>.</t>",{player moveInDriver (_this select 0)},[],1,false,true,"","_this distance _target < 8"];
